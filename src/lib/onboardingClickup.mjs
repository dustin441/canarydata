...
function formatConfirmedProfile(profile = {}) {
  return [
    ...
    '',
    `District news / blog URL:\n${profile.district_news_url || 'None provided'}`,
    '',
    `Frequently covering news outlets:\n${profile.frequent_news_outlets || 'None provided'}`,
    '',
...
export function buildOnboardingTask(input) {
  ...
  return {
    ...
    markdown_content: [
      ...
      `Contact / billing phone: ${request.billing_phone || 'Unknown'}`,
