...
assert.match(dashboard, /RecommendationText[\s\S]*?hasMarkdown[\s\S]*?Recommended next step/);
assert.match(dashboard, /data-recommendation-format=\{hasMarkdown \? 'structured' : 'concise'\}/);
