...
checks = {
    ...
    'topbar keeps a compact mobile trial CTA': 'release-cta-mobile' in client and 'Start Trial' in client,
    'pricing uses the server-resolved transition policy': 'publicPricingLabel' in client and 'Introductory rate through August 31' in client and 'Standard annual access' in client,
